            ...
            <div class="col-lg-6">
                <div id="shopCaro" class="carousel slide" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators singShopTabnav">
                        ...
                        <?php $__currentLoopData = $dress->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <li data-target="#shopCaro" data-slide-to="1" class="active">
                            <img src="<?php echo e(asset('images/' . $image->url)); ?>" alt="">
                        </li>
            ...
            <div class="col-lg-6 noPaddingLeft">
                <div class="singleProInfo">
                    <div class="productinfoTop">
                        <h2 class="productSiTitle"><?php echo e($dress->name); ?></h2>
                ...
                <div class="sinShopCont">
                    <p>
                        <?php echo e($dress->description); ?>

                    </p>
                </div>
                <h3 class="stokPrduct"><?php echo e(__('admin.avilible')); ?>: 15 </h3>
                <div class="ctyandColor">
                    ...
                    <div class="quantityW">
                        <h4><?php echo e(__('admin.quantity')); ?>:</h4>
                        <div class="quantity">
                ...
                <div class="cartButtons">
                        ...
                        <input type="hidden" value="<?php if($dress->product_discount): ?><?php echo e($dress->price * ($dress->product_discount->discount->discount_percent / 100)); ?><?php else: ?><?php echo e($dress->price); ?><?php endif; ?> " name="price">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mojta\OneDrive\Desktop\project\abaya v2\resources\views/front/pages/detail.blade.php ENDPATH**/ ?>