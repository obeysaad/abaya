<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true">
    ...
    <li class=" nav-item"><a href="#"><i class="la la-terminal"></i><span class="menu-title" data-i18n="nav.form_elements.main"><?php echo e(__('message.discount')); ?></span></a>
        <ul class="menu-content">
          <li>
            <a class="menu-item" href="<?php echo e(route('discount.index')); ?>" data-i18n="nav.form_elements.form_inputs"><?php echo e(__('message.discount')); ?></a>
          </li>

          <li>
            <a class="menu-item" href="<?php echo e(route('coupon.index')); ?>" data-i18n="nav.form_elements.form_inputs"><?php echo e(__('admin.coupon')); ?></a>
          </li>
    ...
    <li class=" nav-item"><a href="#"><i class="fa fa-pie-chart" aria-hidden="true"></i><span class="menu-title" data-i18n="nav.form_elements.main"><?php echo e(__('admin.chart')); ?></span></a>
        <ul class="menu-content">
          <li>
            <a class="menu-item" href="<?php echo e(route('chart')); ?>" data-i18n="nav.form_elements.form_inputs"><?php echo e(__('admin.order')); ?></a>
          </li>
      ...
      <li class="nav-item "><a href="<?php echo e(route('social')); ?>"><i class="fas fa-share-alt"></i><span
        class="menu-title" data-i18n="nav.add_on_drag_drop.main"> </span><?php echo e(__('admin.social')); ?></a>
    </li>



      <li class=" nav-item"><a href="#"><i class="fa fa-cog"></i><span class="menu-title" data-i18n="nav.form_elements.main"><?php echo e(__('admin.setting')); ?></span></a>
        <ul class="menu-content">
          <li>
            <a class="menu-item" href="<?php echo e(route('profile')); ?>" data-i18n="nav.form_elements.form_inputs"><?php echo e(__('admin.profile')); ?></a>
          </li>



          <li>
            <a class="menu-item" href="<?php echo e(route('use')); ?>" data-i18n="nav.form_elements.form_inputs"><?php echo e(__('admin.use')); ?></a>
          </li>
...
<?php /**PATH C:\Users\mojta\OneDrive\Desktop\project\abaya v2\resources\views/admin/includes/sidemenu.blade.php ENDPATH**/ ?>