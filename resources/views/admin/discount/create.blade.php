                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">  {{ __('admin.add') }} {{ __('admin.discount') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  {{ __('admin.add') }} {{ __('admin.discount') }} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('discount.store')}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i>   {{ __('admin.information') }} {{ __('admin.discount') }} </h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> discount_percent </label>
                                                            <input type="text" value="" id="name"
                                                                   class="form-control"
                                                                   placeholder=""
